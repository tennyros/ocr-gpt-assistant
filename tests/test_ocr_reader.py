...
class TestOCRReader(unittest.TestCase):
    ...
    @patch('core.ocr_reader.pytesseract.image_to_string', return_value='recognized text')
    ...
    @patch('core.ocr_reader.check_tesseract_installed', return_value=True)
    @patch('core.ocr_reader.pytesseract.image_to_string', side_effect=Exception('ocr error'))
